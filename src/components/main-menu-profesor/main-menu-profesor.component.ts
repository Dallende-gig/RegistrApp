...
@Component({
  selector: 'app-main-menu-profesor',
  templateUrl: './main-menu-profesor.component.html',
  styleUrls: ['./main-menu-profesor.component.scss'],
})
export class MainMenuProfesorComponent  implements OnInit {
